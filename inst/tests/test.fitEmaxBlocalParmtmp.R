...
prior <- emaxPrior.control(epmu=-0, epsca=30,
                               ...
                               difTargetmu=0, difTargetsca=30,
                                dTarget=350,p50=50,sigmalow=.1,sigmaup=30)
...
runsim<-function(j,seed,nsim){
	...
	### bayes prior
	prior <- emaxPrior.control(epmu=-5, epsca=30,
	                           mixP=3, 
	                           w_ep= c(0.3, 0.2, 0.5),
	                           mu_ep= c(5, 10,  0),
	                           sd_ep = c( 3, 9, 30),
...
prior <- emaxPrior.control(epmu=-0, epsca=4,
                           ...
                           dTarget=1.0,p50=0.5,binary=TRUE)
...
=======
	prior <- emaxPrior.control(epmu=-5, epsca=30,
>>>>>>> dfbcb4c0b02fa404e6358776e5d2952b7b98b3df
	                           mixP=3, 
	                           w_ep= c(0.3, 0.2, 0.5),
	                           mu_ep= c(5, 10,  0),
	                           sd_ep = c( 3, 9, 30),
...
runsim<-function(j,seed,nsim){
  ...
  #                       p50=50,parmDF=5,binary=TRUE)
	prior <- emaxPrior.control(epmu=-0, epsca=4,
	                           mixP=3, 
	                           w_ep= c(0.3, 0.2, 0.5),
	                           mu_ep= c(-1.20,-1.40,-1.50),
	                           sd_ep = c( 0.2537, 0.6531, 2.3109),
	                           difTargetmu=0, difTargetsca=4,
<<<<<<< HEAD
	                           dTarget=1.0,p50=15,binary=TRUE)
=======
	                           dTarget=350,p50=50,binary=TRUE)
>>>>>>> dfbcb4c0b02fa404e6358776e5d2952b7b98b3df
...
test_that("plot.fitEmaxB CI DIF for binary data agree within 0.05",{
	expect_that(clev,
							equals(as.numeric(mean(apply(covdifci[,-1],2,mean,na.rm=TRUE))),
										 tolerance=0.05,scale=1))
})

#test_that("plot.fitEmaxB CI DIF for binary data agree within 0.04",{
#	expect_that(clev,
#							equals(as.numeric(mean(apply(covdifci[,-1],2,mean,na.rm=TRUE))),
#										 tolerance=0.04,scale=1))
#})

test_that("plot.fitEmaxB PI DIF for binary data agree within 0.05",{
	expect_that(clev,
							equals(as.numeric(mean(apply(covdifpi[,-1],2,mean,na.rm=TRUE))),
										 tolerance=0.05,scale=1))
})

#test_that("plot.fitEmaxB PI DIF for binary data agree within 0.04",{
#	expect_that(clev,
#							equals(as.numeric(mean(apply(covdifpi[,-1],2,mean,na.rm=TRUE))),
#										 tolerance=0.04,scale=1))
#})
...
<<<<<<< HEAD
                           ...
                           basemu=basemu,basevar=basevar)
=======
                           dTarget=350,p50=50,sigmalow=.1,sigmaup=30, basemu=basemu,basevar=basevar)
>>>>>>> dfbcb4c0b02fa404e6358776e5d2952b7b98b3df
...
<<<<<<< HEAD
                           ...
                           basemu=basemu,basevar=basevar,binary=TRUE)
=======
                           dTarget=350,p50=50, basemu=basemu,basevar=basevar,binary=TRUE)
>>>>>>> dfbcb4c0b02fa404e6358776e5d2952b7b98b3df
...
emaxPrior.control(epmu=-qlogis(0.5), epsca=2,
                  mixP=3, 
                  w_ep= c(0.3, 0.2, 0.5),
                  mu_ep= c(-1.095, -1.109, -1.101),
                  sd_ep = c( 0.2537, 0.6531, 2.3109),
