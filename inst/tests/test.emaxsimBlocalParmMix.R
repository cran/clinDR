context('emaxsimB evaluations with mixture pbo prior')
...
prior <- emaxPrior.control(epmu=-0, epsca=3,
                           mixP=3, 
                           w_ep= c(0.3, 0.2, 0.5),
                           mu_ep= c(5, 10,  0),
                           sd_ep = c( 3, 9, 30),
                           difTargetmu=0, difTargetsca=3,
                           dTarget=0.5,p50=1.0,sigmalow=.1,sigmaup=5,parmDF=5)
...
#                           sd_ep = c( 3, 9, 30),
                           sd_ep = c( 3, 3, 3),
                           difTargetmu=0, difTargetsca=3,
#                           dTarget=1.0, p50=0.5,sigmalow=.1,sigmaup=5,parmDF=5)
                           dTarget=1.0, p50=0.5,sigmalow=.001,sigmaup=5,parmDF=5)
...
prior <- emaxPrior.control(epmu=-qlogis(0.2), epsca=4,
                           mixP=3, 
                           w_ep= c(0.3, 0.2, 0.5),
                           mu_ep= c(-1.095, -1.109, -1.101),
                           sd_ep = c( 0.2537, 0.6531, 2.3109),
                           difTargetmu=0, difTargetsca=4,
                           dTarget=16*0.033,p50=0.05,parmDF=5,binary=TRUE)
...
prior <- emaxPrior.control(epmu=-0, epsca=30,
                           mixP=3, 
                           w_ep= c(0.3, 0.2, 0.5),
                           mu_ep= c(5, 10,  0),
                           sd_ep = c( 3, 9, 30),
                           difTargetmu=0, difTargetsca=30,
                           dTarget=100, p50=50,sigmalow=.1,sigmaup=30,parmDF=5)
...
prior <- emaxPrior.control(epmu=-0, epsca=30,
                           ...
                           sd_ep = c( 3, 9, 30),
                           difTargetmu=0, difTargetsca=30,
                           dTarget=100, p50=50,sigmalow=.1,sigmaup=30)
...
prior <- emaxPrior.control(epmu=-qlogis(0.2), epsca=4,
                           ...
                           sd_ep = c( 0.2537, 0.6531, 2.3109),
                           difTargetmu=0, difTargetsca=4,
                           dTarget=16*0.033,p50=0.05,binary=TRUE)
...
sd_ep <- c( 3, 9, 30)
m<-length(w_ep)
epmu<-weighted.mean(mu_ep,w_ep)
epsca<- sqrt(weighted.mean(sd_ep^2,w_ep) + sum(w_ep*(mu_ep-epmu)^2) )

priorbay<-emaxPrior.control(epmu=epmu, epsca=epsca,
                            mixP=0, 

                            difTargetmu=1, difTargetsca=0.5,
                            dTarget=150, p50=25,parmDF=100,sigmalow=1.2,sigmaup=1.8)
...
prior <- emaxPrior.control(epmu=-0, epsca=4,
                           ...
                           sd_ep = c( 3, 9, 30),
                           difTargetmu=0, difTargetsca=4,
                           dTarget=150, p50=7.5,sigmalow=0.01,sigmaup=3)
...
priorE <- emaxPrior.control(epmu=-0, epsca=4,
                           mixP=3, 
                           w_ep= c(0.3, 0.2, 0.5),
                           mu_ep= c(5, 10,  0),
                           sd_ep = c( 3, 9, 30),
                           difTargetmu=0, difTargetsca=4,
                           dTarget=2000, p50=7.5,sigmalow=0.01,sigmaup=3)
...
priorbay <- emaxPrior.control(epmu=epmu, epsca=epsca,
                            ...
                            dTarget=150,p50=50,parmDF=100,binary=TRUE)



genparmbayb<-randomEmax(priorbay,n,doselev, modType='4' )

priorb <- emaxPrior.control(epmu=-0, epsca=4,
                           mixP=3, 
                           w_ep= c(0.3, 0.2, 0.5),
                           mu_ep= c(-1.095, -1.109, -1.101),
                           sd_ep = c( 0.2537, 0.6531, 2.3109),
